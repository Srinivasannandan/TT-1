    ...
    public class UserController : BaseApiController
    {
        ...
        public HttpResponseMessage CreateUser(Guid userId, [FromBody] UserModel model)
        {
            ...
            if (user == null)
            {
                ...
                return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "User Deatils with same ID already Exist");
            }
        ...
        public HttpResponseMessage UpdateUser(Guid userId, [FromBody] UserModel model)
        {
            if(model==null)
            {
                return Request.CreateErrorResponse( HttpStatusCode.BadRequest, "User Details are required.");
            }
        ...
        public HttpResponseMessage GetUsersByTag(string tag)
        {
            ...
            return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "Feature not supported.");
        }
    }
}